      ...
      <Shell.Content>
        <main className="flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center">
          ...
          <p className="max-w-md text-zinc-500">
            Hover the handles around the rim to open slots. Two handles share
            the bottom and top edges, so the notch slides between them; the
            search and command palettes grow as results load.
          </p>
        </main>
      </Shell.Content>
    </Shell>
