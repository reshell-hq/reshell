...
/**
 * How a link presents in the UI (CONTEXT: "Link"). Display uses whatever the
 * link provides: a custom title, else one derived from the URL hostname; a
 * custom image, else a favicon derived from the URL.
 */
