/**
 * Fractional order keys for user-ordered placements (edge groups, links within
 * a group, focus tasks, etc.). Fractional indices give stable insert/reorder
 * without renumbering the whole list (CONTEXT: "Fractional order").
 */
